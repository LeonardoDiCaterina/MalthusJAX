...
import pandas as pd
from malthusjax.benchmarking.results import RunResult, ExperimentResult, ComparisonResult
...
def main():
    ...
    parser.add_argument("--dir", type=str, required=True, help="Base directory (e.g. results/h1_parity_qdax)")
