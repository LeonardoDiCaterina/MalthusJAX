...
from malthusjax.composer.kozax_adapter import KozaxEngineAdapter, build_kozax_engine
...
class TestKozaxAdapter(BaseAdapterTestSuite):
    ...
    def test_maximize_flag_changes_outcome(self):
        pytest.skip("Kozax native mode uses native evaluator which always minimizes. Maximize flag only affects metrics.")
