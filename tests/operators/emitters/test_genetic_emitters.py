...
class MockRepertoire:
    ...
    def select(self, key, batch_size):
        ...
        return type('MockSelected', (object,), {'genotypes': jax.random.normal(key, (batch_size, self.genotypes.shape[1]))})()
...
def test_genetic_crossover_emitter():
    ...
    emitter = GeneticCrossoverEmitter(_batch_size=32, crossover=crossover, genome_config=genome_config)
