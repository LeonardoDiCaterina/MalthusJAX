...
def test_resource_map_accepts_strategy():
    ...
    rmap_split = compute_resource_map(selection, crossover, mutation, genome_config, pop_size, key_derivation=KeyDerivationStrategy.SPLIT)
    rmap_fold = compute_resource_map(selection, crossover, mutation, genome_config, pop_size, key_derivation=KeyDerivationStrategy.FOLD)
...
def test_resource_mapper_get_keys(strategy, prng_key):
    ...
    rmap = compute_resource_map(selection, crossover, mutation, genome_config, pop_size, key_derivation=strategy)
