...
print(f"JIT Compiling & Running {generations} Generations ({pop_size * generations:,} evaluations)...")
start_t = time.time()
...
plt.scatter(pareto_f1, pareto_f2, color='red', edgecolors='k', alpha=0.9, label='Pareto Front (Rank 0)')
