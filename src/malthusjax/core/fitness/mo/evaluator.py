...
from malthusjax.core.fitness.base import BaseEvaluator, C, D, G
...
class BaseMOEvaluator(BaseEvaluator[G, C, D]):
    ...
    def evaluate_population(self, population: BasePopulation[G]) -> MOPopulation:
        ...
        base_pop = cast(BasePopulation[G], population.replace(fitness=fitness_scores))  # type: ignore[attr-defined]
