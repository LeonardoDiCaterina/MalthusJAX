...
def _operator_decorator(name: str, defaults: Optional[Dict[str, Any]] = None, override: bool = True) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
...
def _engine_decorator(name: str, defaults: Optional[Dict[str, Any]] = None, override: bool = True) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
...
def _genome_decorator(name: str, defaults: Optional[Dict[str, Any]] = None, override: bool = True) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
