...
class TensorNEATEngineAdapter:
    ...
    def _adapter_init(self, algorithm: Any, key: chex.Array, params: Any, pop_init: Any = None) -> Any:
        ...
        try:
            ...
            raise ImportError("TensorNEAT is not installed. Please install it to use the TensorNEAT adapter.")
    ...
    def _adapter_step(self, algorithm: Any, state: Any, key: chex.Array, params: Any, evaluator: Any, eval_translator: Callable) -> Tuple[Any, Dict]:
        # Update randkey
        ...
        safe_reported = jnp.where(valid_mask, reported_fitness, 
                                  -jnp.inf if maximize else jnp.inf)
        
        metrics = {
            "best_fitness_in_generation": jnp.max(safe_reported) if maximize else jnp.min(safe_reported),
