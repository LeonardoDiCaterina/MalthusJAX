"""MEP Experiment 1 using the native MalthusJAX engine.

Reproduces the first experiment from Oltean & Dumitrescu (2002) using
the MalthusJAX GeneticEngine pipeline instead of manual jax.lax.scan loops.
"""
...
def run_experiment(args):
    print("=" * 60)
    print("MEP Experiment 1 (Native Engine): Success Rate vs Length")
    print("=" * 60)
    ...
    plt.title("MEP Experiment 1 (Native Engine): Success Rate vs Chromosome Length")
    plt.grid(True, linestyle="--", alpha=0.7)
    plt.legend()

    out_path = os.path.join(os.path.dirname(__file__), "..", "mep_experiment_1_engine.png")
