...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \input{results/h1_parity_lhs/analysis/parity_wilcoxon_table.tex}
    }
\end{table}
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \input{results/h1_parity_lhs/analysis/ols_regression_table.tex}
    }
\end{table}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{results/h1_parity_lhs/analysis/malthusjax_wrapper_vs_evosax_baseline_sphere_execution_time_scaling.png}
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \input{results/h2_ablation_lhs/analysis/ols_regression_table.tex}
    }
\end{table}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{results/h2_ablation_lhs/analysis/mjx_ablate_mutation_vs_mjx_baseline_sphere_execution_time_scaling.png}
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \input{results/h3_representation_lhs/analysis/parity_wilcoxon_table.tex}
    }
\end{table}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{results/h3_representation_lhs/analysis/mjx_bf16_vs_mjx_f32_rosenbrock_boxplots.png}
